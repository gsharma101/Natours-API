...
// Send token via cookie and respond
...
// CHECK IF LOGGED IN (for views only)
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  const message = `Forgot your password? Reset here:\n${resetURL}`;

  const html = `
    <div style="font-family: Arial, sans-serif; padding: 20px; border-radius: 8px;">
      <h2 style="color: #55c57a;">Reset your password</h2>
